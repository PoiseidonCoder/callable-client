...
const LoginPage = () => {
  ...
  return (
    <Card className="w-[384px] opacity-95">
      <CardHeader>
        <CardTitle className="text-center text-3xl">{t("login")}</CardTitle>
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Button
                        type="button"
                        className="absolute top-0 right-1 cursor-pointer hover:bg-transparent"
                        variant={"ghost"}
            ...
            />
            <Button type="submit" className="w-full mt-3 py-2 bg-btn-gradient">
              {t("login")}
            </Button>
          </form>
        </Form>
      ...
      <CardFooter className="flex flex-col gap-2">
        ...
        <Label>
          <Link className="text-muted-foreground" href={AUTH_ROUTES.REGISTER}>
            {t("notAccount")}
            <span className="text-foreground">&nbsp;{t("suggestRegister")}</span>
          </Link>
        </Label>
      </CardFooter>
    </Card>
